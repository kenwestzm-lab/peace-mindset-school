    ...
    <div style={root}>
      ...
      <div style={inputBarStyle}>
        ...
        {grpInput.trim()?<button onClick={sendGrpText} style={sendBtnStyle}>➤</button>
          :<button style={{...sendBtnStyle,background:'#00A884'}} onMouseDown={startRec} onMouseUp={stopRec} onTouchStart={e=>{e.preventDefault();startRec();}} onTouchEnd={stopRec}>{recording?'⏹':'🎤'}</button>}
      </div>
    </div>);
