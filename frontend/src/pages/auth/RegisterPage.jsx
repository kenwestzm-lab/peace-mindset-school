      ...
      <div style={{
        ...
        <div style={{ textAlign:'center', marginBottom:22, position:'relative', zIndex:1 }}>
          <div style={{
            ...
            <img src="/logo.webp" alt="Logo"
              ...
              onError={e => { e.target.style.display='none'; e.target.parentNode.innerHTML='🕊️'; e.target.parentNode.style.fontSize='38px'; }}
            />
          </div>
          <h1 style={{ fontFamily:'var(--font-display)', fontSize:21, fontWeight:700, color:'#fff', lineHeight:1.2 }}>
            Peace Mindset Private School
          </h1>
          <div style={{ fontFamily:'var(--font-title)', fontSize:9, letterSpacing:'0.2em', color:'var(--gold-light)', textTransform:'uppercase', marginTop:4 }}>
            Better Education
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ padding:'24px 24px 8px' }}>
            <h2 style={{ fontFamily:'var(--font-display)', fontSize:24, color:'var(--maroon-dark)', marginBottom:3 }}>
              {t('registerTitle')}
            </h2>
            <p style={{ fontSize:13, color:'var(--gray-400)', marginBottom:18 }}>{t('registerSubtitle')}</p>
            ...
            <form onSubmit={handleSubmit} autoComplete="on">
              ...
              <div className="form-group">
                <label className="form-label">
                  {t('phone')}{' '}
                  <span style={{ fontWeight:400, textTransform:'none', fontSize:11, color:'var(--gray-400)' }}>({t('optional')})</span>
                </label>
                <input
                  type="tel"
                  className="form-input"
          ...
          <div style={{ padding:'14px 24px 22px', textAlign:'center' }}>
            <p style={{ fontSize:13.5, color:'var(--gray-500)' }}>
              ...
              <Link to="/login" style={{ color:'var(--maroon)', fontWeight:700 }}>{t('login')} →</Link>
            </p>
          </div>
        </div>
      </div>
