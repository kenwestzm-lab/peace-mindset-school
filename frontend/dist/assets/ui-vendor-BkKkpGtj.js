...
to {
  ...
  animation: ${K} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,V=({toast:e})=>{let{icon:t,type:r,iconTheme:a}=e;return void 0!==t?"string"==typeof t?d.createElement(Q,null,t):t:"blank"===r?null:d.createElement(J,null,d.createElement(q,n({},a)),"loading"!==r&&d.createElement(G,null,"error"===r?d.createElement(R,n({},a)):d.createElement(Z,n({},a))))},W=e=>`\n0% {transform: translate3d(0,${-200*e}%,0) scale(.6); opacity:.5;}\n100% {transform: translate3d(0,0,0) scale(1); opacity:1;}\n`,X=e=>`\n0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}\n100% {transform: translate3d(0,${-150*e}%,-1px) scale(.6); opacity:0;}\n`,ee=E("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
