...
const paymentSchema = new mongoose.Schema(
  {
    ...
    paymentType: {
      ...
      enum: [
        ...
        "test_fee", "event_fee",           // Exam/test results fee
      ],
      required: true,
    },
    // ── Zambian term info ─────────────────────────────────────────────
    ...
    // ── Test fee specific ─────────────────────────────────────────────
    eventId: { type: require("mongoose").Schema.Types.ObjectId, ref: "Event", default: null },
  testResultAccessed: { type: Boolean, default: false }, // Once viewed, fee consumed
    ...
    remainingBalance: { type: Number, default: 0 }, // Still owed
    fullAmount: { type: Number },                   // Original full amount
    installments: [{ amount: Number, date: Date, ref: String }],
